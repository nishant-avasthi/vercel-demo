      ...
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        <div className="max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
          <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
            ...
            <code className="font-mono font-bold">Hello World!!! from here</code>
          </p>
        ...
        <div className="mb-32 grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-4">
          {/* You can add items here resembling products in a warehouse */}
          <div className="rounded-lg bg-gray-200 p-6 transform hover:scale-105 transition duration-300 ease-in-out">
